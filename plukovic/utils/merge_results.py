...
def main():
    ...
    parser.add_argument('--num_clicks', type=int, required=True, help='Number of clicks', default=1)
    args = parser.parse_args()

    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    merge_csv_files(args.input_folder, args.output_folder, timestamp, num_clicks=args.num_clicks)
