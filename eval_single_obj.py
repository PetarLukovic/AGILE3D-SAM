...
from plukovic.scannet.kitti360_scene import KITTI360SensorData
...
def get_args_parser():
    ...
    parser.add_argument('--end_index', default=1, help='end index of the dataset', type=int)
...
def Evaluate(model, data_loader, args, device):
    ...
    for batched_inputs in metric_logger.log_every(data_loader, 10, header):
        ...
        sensors = KITTI360SensorData(os.path.join(args.scan_folder, scene_name[0] + '.ply'))
